...
namespace FluiTec.AppFx.Localization.Dapper.Mysql.Repositories
{
    ...
    /// </summary>
    public class MysqlResourceRepository : DapperResourceRepository
    {
        /// <summary>
        ///     Constructor.
        /// </summary>
        ...
        public MysqlResourceRepository(DapperUnitOfWork unitOfWork, ILogger<IRepository> logger) : base(unitOfWork,
            logger)
        {
        }
