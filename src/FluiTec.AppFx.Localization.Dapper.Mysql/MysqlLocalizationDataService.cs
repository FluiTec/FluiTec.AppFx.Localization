...
namespace FluiTec.AppFx.Localization.Dapper.Mysql
{
    ...
    public class MysqlLocalizationDataService : DapperLocalizationDataService
    {
        ...
        public MysqlLocalizationDataService(IDapperServiceOptions dapperServiceOptions, ILoggerFactory loggerFactory) : base(dapperServiceOptions, loggerFactory)
        {
        }
        ...
        /// <param name="dapperServiceOptions"> Options for controlling the dapper service. </param>
        /// <param name="loggerFactory">        The logger factory. </param>
        public MysqlLocalizationDataService(IOptionsMonitor<IDapperServiceOptions> dapperServiceOptions, ILoggerFactory loggerFactory) : base(dapperServiceOptions, loggerFactory)
        {
        }
        ...
        public override DapperLocalizationUnitOfWork BeginUnitOfWork(IUnitOfWork other)
        {
            ...
            return new MysqlLocalizationUnitOfWork(work, this, LoggerFactory?.CreateLogger<IUnitOfWork>());
        }
    }
}