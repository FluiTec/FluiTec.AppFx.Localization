...
namespace FluiTec.AppFx.Localization.Dapper.Pgsql
{
    ...
    public class PgsqlLocalizationDataService : DapperLocalizationDataService
    {
        ...
        public PgsqlLocalizationDataService(IDapperServiceOptions dapperServiceOptions, ILoggerFactory loggerFactory) : base(dapperServiceOptions, loggerFactory)
        {
        }
        ...
        /// <param name="dapperServiceOptions"> Options for controlling the dapper service. </param>
        /// <param name="loggerFactory">        The logger factory. </param>
        public PgsqlLocalizationDataService(IOptionsMonitor<IDapperServiceOptions> dapperServiceOptions, ILoggerFactory loggerFactory) : base(dapperServiceOptions, loggerFactory)
        {
        }
        ...
        public override DapperLocalizationUnitOfWork BeginUnitOfWork(IUnitOfWork other)
        {
            ...
            return new PgsqlLocalizationUnitOfWork(work, this, LoggerFactory?.CreateLogger<IUnitOfWork>());
        }
    }
}