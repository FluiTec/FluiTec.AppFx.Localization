...
internal class Program
{
    ...
    private static void TestScanner()
    {
        ...
        foreach (var a in aScanner.GetAssemblies())
        {
            ...
            foreach (var t in tScanner.GetTypes(a))
            {
                ...
                foreach (var m in mScanner.GetMembers(t)) System.Console.WriteLine($">-> {m.Name}");
            }
        }
    }
    ...
    private static IServiceProvider GetServiceProvider()
    {
        var config = new ConfigurationBuilder()
            .AddInMemoryCollection(new[]
            {
                ...
                new KeyValuePair<string, string>("ServiceLocalizationOptions:MemoryCacheEntryOptions:SlidingExpiration",
                    "00:15:00"),
                ...
                new KeyValuePair<string, string>("ServiceLocalizationImportOptions:UpdateableAuthors:1",
                    "Import-File (json)")
            })
            .Build();
    ...
    private static void AddSampleData(IServiceProvider serviceProvider)
    {
        ...
        var language2 = uow.LanguageRepository.Add(new LanguageEntity
            {IsoName = "de-DE", Name = "Deutsch (Deutschland)"});
        var resource1 = uow.ResourceRepository.Add(new ResourceEntity
        {
            ResourceKey = "FluiTec.AppFx.Localization.CliTest.Program.Key", ModificationDate = DateTimeOffset.UtcNow,
            AuthorId = author1.Id
        });
        ...
        {
            ResourceKey = "FluiTec.AppFx.Localization.CliTest.Program.Key2", ModificationDate = DateTimeOffset.UtcNow,
            AuthorId = author1.Id
        });
...
public enum Enum
{
    [Translation("iv", "Invariant")] [Translation("de", "Deutsch")] [Translation("de-DE", "Deutsch (Deutschland)")]
    Var1,
