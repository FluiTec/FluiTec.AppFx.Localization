...
{
    /// <summary>
    /// A dependency localization data test.
    /// </summary>
    ///
    /// <typeparam name="TEntity">  Type of the entity. </typeparam>
    public abstract class DependencyLocalizationDataTest<TEntity> : DependencyEntityDataTest<ILocalizationDataService, ILocalizationUnitOfWork, TEntity, int>
        where TEntity : class, IKeyEntity<int>, IEquatable<TEntity>, new()
    {
        ...
        protected DependencyLocalizationDataTest(DataServiceProvider<ILocalizationDataService, ILocalizationUnitOfWork> dataServiceProvider) : base(dataServiceProvider)
        {
        }
