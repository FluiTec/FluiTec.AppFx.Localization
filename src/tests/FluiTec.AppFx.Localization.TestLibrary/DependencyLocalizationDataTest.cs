...
public abstract class
    DependencyLocalizationDataTest<TEntity> : DependencyEntityDataTest<ILocalizationDataService, ILocalizationUnitOfWork
        , TEntity, int>
    where TEntity : class, IKeyEntity<int>, IEquatable<TEntity>, new()
{
    ...
    protected DependencyLocalizationDataTest(
