...
namespace FluiTec.AppFx.Localization.TestLibrary
{
    ...
    /// </summary>
    public abstract class LocalizationDataTest<TEntity> : EntityDataTest<ILocalizationDataService, ILocalizationUnitOfWork, TEntity, int> 
        where TEntity : class, IKeyEntity<int>, IEquatable<TEntity>, new()
    {
        ...
        protected LocalizationDataTest(DataServiceProvider<ILocalizationDataService, ILocalizationUnitOfWork> dataServiceProvider) : base(dataServiceProvider)
        {
        }
