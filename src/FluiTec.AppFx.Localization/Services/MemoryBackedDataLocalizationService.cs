...
namespace FluiTec.AppFx.Localization.Services
{
    ...
    public class MemoryBackedDataLocalizationService : DataLocalizationService
    {
        ...
        public MemoryBackedDataLocalizationService(ServiceLocalizationOptions options, IMemoryCache cache,
            ILocalizationDataService dataService, ITranslationPickingService translationPickingService,
        ...
        {
            return GetOrCreateWithPolicy(Cache, $"{name}+{culture.Name}", cacheEntry => base.ByName(name, culture),
        ...
        {
            return GetOrCreateWithPolicy(Cache, $"{baseName}+{culture.Name}",
                cacheEntry => base.ByBaseName(baseName, culture), Options.MemoryCacheEntryOptions);
        }
        ...
        /// </returns>
        private static TItem GetOrCreateWithPolicy<TItem>(IMemoryCache cache, object key,
            Func<ICacheEntry, TItem> factory, MemoryCacheEntryOptions entryOptions)
        {
