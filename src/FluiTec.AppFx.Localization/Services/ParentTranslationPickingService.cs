...
namespace FluiTec.AppFx.Localization.Services
{
    ...
    public class ParentTranslationPickingService : ITranslationPickingService
    {
        ...
        /// A LocalizedStringEx.
        /// </returns>
        public LocalizedStringEx Pick(IList<CompoundTranslationEntity> translations, CultureInfo culture, string sourceName)
        {
        ...
        /// A LocalizedStringEx.
        /// </returns>
        public IEnumerable<CompoundTranslationEntity> Pick(IList<IGrouping<string, CompoundTranslationEntity>> groups, CultureInfo culture)
        {
            var ratings = GetCultureRating(culture);
            return groups
                .Select(g => g
        ...
        /// A LocalizedStringEx.
        /// </returns>
        public IEnumerable<LocalizedStringEx> Pick(IList<IGrouping<string, CompoundTranslationEntity>> groups, CultureInfo culture, string sourceName)
        {
