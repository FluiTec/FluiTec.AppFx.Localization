...
namespace FluiTec.AppFx.Localization.Models
{
    ...
    public class LocalizedStringEx : LocalizedString
    {
        ...
        public LocalizedStringEx(string name, string value, bool resourceNotFound, string searchedLocation,
            string language) : base(name, value, resourceNotFound, searchedLocation)
        {
            Language = language;
        }
