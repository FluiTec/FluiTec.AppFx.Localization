...
{
    /// <summary>   A service for accessing mssql localization data information. </summary>
    public class MssqlLocalizationDataService : DapperLocalizationDataService
    {
        ...
        public MssqlLocalizationDataService(IDapperServiceOptions dapperServiceOptions, ILoggerFactory loggerFactory) :
        ...
        public override DapperLocalizationUnitOfWork BeginUnitOfWork(IUnitOfWork other)
        {
            ...
            return new MssqlLocalizationUnitOfWork((DapperUnitOfWork) other, this,
