...
namespace FluiTec.AppFx.Localization.Dapper.Sqlite
{
    ...
    public class SqliteLocalizationDataService : DapperLocalizationDataService
    {
        ...
        public SqliteLocalizationDataService(IDapperServiceOptions dapperServiceOptions, ILoggerFactory loggerFactory) : base(dapperServiceOptions, loggerFactory)
        {
        }
        ...
        /// <param name="dapperServiceOptions"> Options for controlling the dapper service. </param>
        /// <param name="loggerFactory">        The logger factory. </param>
        public SqliteLocalizationDataService(IOptionsMonitor<IDapperServiceOptions> dapperServiceOptions, ILoggerFactory loggerFactory) : base(dapperServiceOptions, loggerFactory)
        {
        }
        ...
        public override DapperLocalizationUnitOfWork BeginUnitOfWork(IUnitOfWork other)
        {
            ...
            return new SqliteLocalizationUnitOfWork(work, this, LoggerFactory?.CreateLogger<IUnitOfWork>());
        }
    }
}